...
module.exports = (app) => {
  ...
  app.post('/api/classroom/:classroomCode/regenerate', instructorMiddleware2, instructor.classrooms.regenerateCode);
  ...
  app.patch('/api/classroom/:classroomCode/assignments/:assignmentCode', instructorMiddleware2, instructor.assignments.patch);
